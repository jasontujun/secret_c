...
#define ERROR_COMMON_FILE_R_OPEN_FAIL -3
#define ERROR_COMMON_FILE_W_OPEN_FAIL -4
#define ERROR_COMMON_FILE_READ_FAIL -5
#define ERROR_COMMON_FILE_WRITE_FAIL -6
#define ERROR_COMMON_META_PARSE_FAIL -7
#define ERROR_COMMON_META_CREATE_FAIL -8
#define ERROR_COMMON_CRC_CHECK_FAIL -9
#define ERROR_COMMON_CRC_CAL_FAIL -10
